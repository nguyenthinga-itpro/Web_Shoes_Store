 ...
 */
@WebServlet(name = "CancelOrderControl", urlPatterns = {"/Cancel"})
public class CancelOrderControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cancelID != null && reason != null && !reason.isEmpty()) {
            CancelOrderDAO dao = new CancelOrderDAO();
            boolean success = dao.updateStatus(Integer.parseInt(cancelID), reason);
