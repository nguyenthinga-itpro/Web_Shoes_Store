...
import dao.DAO;
import dao.OrderDetailAdminDAO;
 ...
 * @author ADMIN
 */
@WebServlet(name = "OrderDetailAdminControl", urlPatterns = {"/OrderDetailAdminControl"})
public class OrderDetailAdminControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        OrderDetailAdminDAO dao = new OrderDetailAdminDAO();
